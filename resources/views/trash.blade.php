              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <a class="btn btn-primary btn-lg" href="{{ route('trash.create') }}">Tambah Sampah</a>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <form method="GET" action="{{route('trash.index')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        <a class="btn btn-success btn-lg" href="{{route('trash.index')}}">Refresh</a>
                      </div>
                    </div>
                  </div>
                    ...
                    <table class="table table-hover">
                      <thead>
                        <tr class="table-info">
                          ...
                          <th class="card-title text-primary">Kategori</th>
                        ...
                        <tr>
                          ...
                          <td>
                            <form action="{{ route('trash.destroy', $item->id) }}" method="post">
                                <a class="btn btn-outline-warning btn-fw" href="{{route('trash.edit',$item->id)}}">Edit</a>
                                @csrf
                                @method('DELETE')
                  ...
                  <div class="row justify-content-center">
                    {!! $trash->appends(Request::only(['search'=>'search']))->render() !!}
                  </div>
                </div>
              </div>
            </div>
