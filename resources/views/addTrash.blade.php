          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <form class="form-sample" action="{{route('trash.store')}}" method="post">
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="trash_name" class="form-control" value="{{ old('trash_name') }}" placeholder="Masukkan Nama Sampah" autocomplete="off">
